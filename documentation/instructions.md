...
1. На [странице проекта](https://stash.korona.net/projects/SHIFT/repos/backend-winter-2026/browse) скопировать ссылку на репозиторий;
...
1. Откройте терминал git bash и выполните команду:
   ```bash
   git clone https://stash.korona.net/project/SHIFT/repos/backend-winter-2026.git
2. Перейдите в папку проекта
   ```bash 
   cd backend-winter-2026
