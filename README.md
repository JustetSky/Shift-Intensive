...
Для экономии времени и упрощения проверки вам предоставляются [API](documentation/api/openapi.yaml)

## 4. Детальное описание функционала

### Загрузка файла

- При загрузке [файла](documentation/Требования%20к%20файлу.md) содержащего список пользователей для
...
[диаграмма загрузки файла](documentation/images/save_file.png)

### Запуск и обработка файла

1) Сначала проверяется наличие файла и отдается на асинхронную обработку.
2) Обработчик построчно считывает файл, проверяя формат и корректность данных согласно [требованиям](documentation/Требования%20к%20файлу.md).
...
[диаграмма обработки файла](documentation/images/process_file.png)
