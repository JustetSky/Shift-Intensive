...
Для экономии времени и упрощения проверки вам предоставляются [API](api/openapi.yaml)
...
[диаграмма загрузки файла](images/save_file.png)

### Запуск и обработка файла

1) Сначала проверяется наличие файла и отдается на асинхронную обработку.
2) Обработчик построчно считывает файл, проверяя формат и корректность данных согласно [требованиям](Требования%20к%20файлу.md).
...
[диаграмма обработки файла](images/process_file.png)
